...
export default function QuestionsEditHeader2() {
  return (
    <div className="bg-white border-t border-t-gray-100 py-1.5 px-6 flex items-center justify-between">
      {/* Button Bulk Mode */}
      <Button
        className={`flex items-center gap-2.5 text-sm font-medium text-gray-800 h-10 px-4 bg-gray-200 hover:bg-gray-300 cursor-pointer`}
      >
        <CopyPlus size={18} className="text-gray-800" />
        Bulk Add Mode
      </Button>
