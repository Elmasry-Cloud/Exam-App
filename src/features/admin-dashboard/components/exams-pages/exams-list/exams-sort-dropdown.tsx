...
import { IDiplomasFilterProps } from "../../diplomas-pages/diplomas-list-page/diplomas-sort-dropdown";

export default function SortDropdownExams({
  setSortBy,
  setSortOrder,
  examsList,
  ...
  return (
    <>
      ...
      >
        ...
        {/* dropdown Sort */}
        {showSort && (
          <div className="bg-white w-65 z-20 border border-gray-200 absolute top-full right-0 shadow-[0px_4px_10px_0px_#0000000D]">
            ...
            {examsList && (
              <>
                {/* Item Questions No.*/}
                <div
                  onClick={() => handleSort("questions", "desc")}
                  className="item group tran p-3.5 flex items-center gap-2.5 cursor-pointer hover:bg-blue-50"
                >
                  <ArrowDownAZ
                    size={18}
                ...
                {/* Item Questions No.*/}
                <div
                  onClick={() => handleSort("questions", "asc")}
                  className="item group tran p-3.5 flex items-center gap-2.5 cursor-pointer hover:bg-blue-50 hover:font-semibold"
                >
                  <ArrowUpAZ
                    size={18}
